...
### 배움 목표
- School Code가 아닌 **Product Code를 작성**해 실무에서 사용할 수 있는 코드를 적는 개발자가 되기.
- Backend 기술에 필요한 **CS 지식 학습**하여 안정적이고 **효율적인 소프트웨어 구축 능력 향상**.
- **웹 애플리케이션 프레임워크를 이해**하고 활용법을 학습.
- 학습한 지식을 융합하여 **웹 애플리케이션을 개발**하는 경험을 통해 실전 역량 향상 및 프로젝트 수행.
...
[11. SQL 프로시저](https://github.com/UNGGU0704/nhnacademy-study/blob/main/DB/11.%20SQL%20프로시저.md) <br>
